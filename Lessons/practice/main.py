...
# رفتن به child بعدی
# // * [ @class = 'Login.py form' ]/*  and  // * [ @class = 'Login.py form' ]/*/*
# // یعنی من میخوام تمام چیزهایی که از این نقطه به پایین وجود دارند را نگاه کنم
# // * [ @class = 'Login.py form' ] // * [ @value = 'Login.py' ]
# // * [ @class = 'Login.py form' ] / input [ @value = 'Login.py' ]
...
# / parent :: xpath-parent
# رسیدن از child به parent
# // * [ @id = 'uname' ] / parent :: * [ @class = 'Login.py form' ]
# // * [ @id = 'uname' ] / parent :: div [ @class = 'Login.py form' ]
